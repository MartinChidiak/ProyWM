...
# Corregir selección inválida si hay géneros que no están en el tipo actual
valid_genre_filter = [g for g in st.session_state.genre_filter if g in all_genres]

# Si hubo géneros eliminados, actualizamos el session_state
if set(valid_genre_filter) != set(st.session_state.genre_filter):
    st.session_state.genre_filter = valid_genre_filter
    st.rerun()
